...
<header style="background-color:lightgray"> 
	<div class="zerogrid">
		<div class="row">
			<div class="col05">
				<div id="logo"><a href="${pageContext.request.contextPath }/index"><img src="../Images/logo.png"/></a></div>
			</div>
			<div class="col06 offset05">
				<div style="padding-top:20px">
					<ul style="padding-top:18px; padding-left:70%; font-size:13px;">
						...
						<li style="display:inline; margin-left:1rem"><a href="${pageContext.request.contextPath}/LogoutServlet">退出</a></li>
					</ul>
				</div>
			</div>
		</div>
										...
										$.get(
											...
											function(data){
												...
												for(var i=0;i<data.length;i++){
													...
													$("#list").append("<a href=' OpenNewsServlet?nid="+data[i].nid+"'><div style='cursor:pointer' onmouseover='over(this)' onmouseout='out(this)' onmousedown='go(this)'>"+data[i].title+"</div></a >");
												}
...
<nav style="height:41px">
	<ul style="background-color:gray">
		<li><a href="index.jsp" style="background: DimGray">首页</a></li>
		<li><a href="${pageContext.request.contextPath }/2019nCov">疫情</a></li>
		<li><a href="TypeNewsServlet?type=lifestyle">生活</a></li>
		<li><a href="TypeNewsServlet?type=physical">体育</a></li>
		<li><a href="TypeNewsServlet?type=military">军事</a></li>

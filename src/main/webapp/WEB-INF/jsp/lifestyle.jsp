...
<nav style="height:41px">
	<ul>
		...
		<li><a href="TypeNewsServlet?type=lifestyle"style="background: DimGray">生活</a></li>
		...
		<div class="row block">
			<div class="featured col16">
				<div class="rslides_container" style="text-align:center">
					...
					<c:forEach items="${lifestyletodayNewsList}" var="todaynews">
			...
			<div class="sidebar col05">
				...
				<section>
					...
					<div class="content">
						<c:forEach items="${lifestylehotNewsList}" var="hotnews">
			...
			<c:forEach items="${lifestyleallNewsList}" var="news" varStatus="status">
				<article>
					<div class="heading">

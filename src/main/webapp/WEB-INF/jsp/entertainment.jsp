		...
		<div class="row block">
			<div class="featured col16">
				<div class="rslides_container" style="text-align:center">
					...
					<c:forEach items="${entertainmenttodayNewsList}" var="todaynews">
			...
			<div class="sidebar col05">
				...
				<section>
					...
					<div class="content">
						<c:forEach items="${entertainmenthotNewsList}" var="hotnews">
			...
			<c:forEach items="${entertainmentallNewsList}" var="news" varStatus="status">
				<article>
					<div class="heading">

...
<nav style="height:41px">
	<ul>
		...
		<li><a href="TypeNewsServlet?type=world"style="background: DimGray">国际</a></li>
		...
		<div class="row block">
			<div class="featured col16">
				<div class="rslides_container" style="text-align:center">
					...
					<c:forEach items="${worldtodayNewsList}" var="todaynews">
			...
			<div class="sidebar col05">
				...
				<section>
					...
					<div class="content">
						<c:forEach items="${worldhotNewsList}" var="hotnews">
			...
			<c:forEach items="${worldallNewsList}" var="news" varStatus="status">
				<article>
					<div class="heading">

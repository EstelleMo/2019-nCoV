				...
				<TD align="center" bgColor=#ffffff>
					<table width="100%" height=300 border="0" cellpadding="0"
						...
						<c:if test="${!empty student }">
							<tr>
								<td align="center"><img src="${pageContext.request.contextPath }/images/wel.png" width="145"
									height="46" /></td>
							</tr>
						</c:if>
						<c:if test="${empty student }">
							<tr>
								<td align="center"><img src="${pageContext.request.contextPath }/images/jackson.jpg"

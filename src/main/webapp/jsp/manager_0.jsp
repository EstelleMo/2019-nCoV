				...
				<div style="padding-top: 20px">
					<ul
						...
						<li style="display: inline; margin-left: 1rem"><font size="3"
							style="color: darkgreen">${student.name}</font></li>
...
<div class="calendar-title">
      <a href="#" class="title"><span class="year">2017/</span><span class="month">04</span></a>
				...
				<section id="tm-section-1" class="tm-section">
					<div class="ml-auto">
						...
						<div class="user-infoPic">
							...
							<div class="info-m">
								<div>
									<b>用户名：<i>${student.name}</i></b>
								</div>
								<%-- <div>
									<b>用户姓名：<i>${student.realname}</i></b>
								</div> --%>
								<div class="gendar">
									<div>
										<b>性别：<i>${student.gender}</i></b>
									</div>
								</div>
							</div>
						</div>
						<br> <br> <br>
						<h7> <a href="#" class="btn tm-btn tm-font-big"
									...
									<div class="col-md-6 col-sm-12 tm-contact-col">
										<div class="contact_message">
											<form action="/zzxx_news/UpdatePwdServlet" method="post"
												...
												<button type="submit"
													class="btn tm-btn-submit tm-btn ml-auto">确认修改</button>
											</form>
									...
									<div class="col-md-6 col-sm-12 tm-contact-col">
										<div class="contact_message">
											<form action="/zzxx_news/UpdateServlet" method="get"
												class="contact-form">
												<div class="form-group">
													<input type="text" id="contact_name" name="name" id="name"
												...
												<button type="submit"
													class="btn tm-btn-submit tm-btn ml-auto">提交</button>
											</form>
